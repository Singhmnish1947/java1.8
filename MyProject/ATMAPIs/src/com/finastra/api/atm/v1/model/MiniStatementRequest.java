 ...
 */
@ApiModel(description = "Mini Statement Request")
@Validated
...
public class MiniStatementRequest {
	...
	public MiniStatementRequest channelId(String channelId) {
	...
	public MiniStatementRequest primaryAccountNumberIdentifier(String primaryAccountNumberIdentifier) {
	 ...
	 **/
	@ApiModelProperty(example = "10000000000000000", required = true, value = "This is card identifier that is used to link to card number in Card Management application or Switch. Card Identifier is used to trace the transactions in core banking application as well downstream applications such as Digital Channels, and so on.")
	...
	public MiniStatementRequest dateTimeTransmission(Timestamp dateTimeTransmission) {
	...
	public MiniStatementRequest amountCurrencyCardholderBillingFee(String amountCurrencyCardholderBillingFee) {
	 ...
	 **/
	@ApiModelProperty(example = "978", required = true, value = "Indicates the fee currency. Only numeric ISO Code is allowed. For example, 840 (for USD). The Field ID dependent on amountCardholderBillingFee.")
	@NotNull
	...
	public MiniStatementRequest amountCardholderBillingFee(BigDecimal amountCardholderBillingFee) {
	...
	public MiniStatementRequest systemTraceAuditNumber(String systemTraceAuditNumber) {
	...
	public MiniStatementRequest timeLocalTransaction(Timestamp timeLocalTransaction) {
	...
	public MiniStatementRequest messageTypeIdentifier(String messageTypeIdentifier) {
	 ...
	 * values are allowed. For example, 1100 --> Ministatement request, x100, x101
	 * 
	 * @return messageTypeIdentifier
	 **/
	@ApiModelProperty(example = "1100", required = true, value = "The message type identifier is a 4-digit numeric field identifying the message class, message function and transaction originator. Only numeric values are allowed. For example, 1100 --> Ministatement request, x100, x101")
	@NotNull
	...
	public MiniStatementRequest messageFunction(MessageFunctionEnum messageFunction) {
	 ...
	 **/
	@ApiModelProperty(example = "Request", value = "Value indicating the specific purpose of the message within its message class. ")
	...
	public MiniStatementRequest acquiringInstitutionIdentificationCode(String acquiringInstitutionIdentificationCode) {
	...
	public MiniStatementRequest forwardingInstitutionIdentificationCode(
	...
	public MiniStatementRequest retrievalReferenceNumber(String retrievalReferenceNumber) {
	...
	public MiniStatementRequest approvalCode(String approvalCode) {
	...
	public MiniStatementRequest actionCode(String actionCode) {
	...
	public MiniStatementRequest cardAcceptorTerminalIdentification(String cardAcceptorTerminalIdentification) {
	...
	public MiniStatementRequest cardAcceptorIdentificationCode(String cardAcceptorIdentificationCode) {
	...
	public MiniStatementRequest cardAcceptorNameLocation(String cardAcceptorNameLocation) {
	...
	public MiniStatementRequest additionalDataPrivate(String additionalDataPrivate) {
	...
	public MiniStatementRequest dataRecord(String dataRecord) {
	...
	public MiniStatementRequest transactionOriginatorInstitutionIdentificationCode(
	...
	public MiniStatementRequest cardIssuerReferenceNumber(String cardIssuerReferenceNumber) {
	...
	public MiniStatementRequest receivingInstitutionIdentificationCode(String receivingInstitutionIdentificationCode) {
	...
	public MiniStatementRequest accountIdentification1(String accountIdentification1) {
		this.accountIdentification1 = accountIdentification1;
		return this;
	}

	/**
	 * Account identification 1 (Card holder account), Account of mini statement.
	 * 
	 * @return accountIdentification1
	 **/
	@ApiModelProperty(example = "123456788", required = true, value = "Account identification 1 (Card holder account), Account of mini statement.")
	@NotNull
	...
	public boolean equals(java.lang.Object o) {
		...
		MiniStatementRequest miniStatementRequest = (MiniStatementRequest) o;
		return Objects.equals(this.channelId, miniStatementRequest.channelId)
				&& Objects.equals(this.primaryAccountNumberIdentifier,
						miniStatementRequest.primaryAccountNumberIdentifier)
				&& Objects.equals(this.dateTimeTransmission, miniStatementRequest.dateTimeTransmission)
				&& Objects.equals(this.amountCurrencyCardholderBillingFee,
						miniStatementRequest.amountCurrencyCardholderBillingFee)
				&& Objects.equals(this.amountCardholderBillingFee, miniStatementRequest.amountCardholderBillingFee)
				&& Objects.equals(this.systemTraceAuditNumber, miniStatementRequest.systemTraceAuditNumber)
				&& Objects.equals(this.timeLocalTransaction, miniStatementRequest.timeLocalTransaction)
				&& Objects.equals(this.messageTypeIdentifier, miniStatementRequest.messageTypeIdentifier)
				&& Objects.equals(this.messageFunction, miniStatementRequest.messageFunction)
				&& Objects.equals(this.acquiringInstitutionIdentificationCode,
						miniStatementRequest.acquiringInstitutionIdentificationCode)
				&& Objects.equals(this.forwardingInstitutionIdentificationCode,
						miniStatementRequest.forwardingInstitutionIdentificationCode)
				&& Objects.equals(this.retrievalReferenceNumber, miniStatementRequest.retrievalReferenceNumber)
				&& Objects.equals(this.approvalCode, miniStatementRequest.approvalCode)
				&& Objects.equals(this.actionCode, miniStatementRequest.actionCode)
				&& Objects.equals(this.cardAcceptorTerminalIdentification,
						miniStatementRequest.cardAcceptorTerminalIdentification)
				&& Objects.equals(this.cardAcceptorIdentificationCode,
						miniStatementRequest.cardAcceptorIdentificationCode)
				&& Objects.equals(this.cardAcceptorNameLocation, miniStatementRequest.cardAcceptorNameLocation)
				&& Objects.equals(this.additionalDataPrivate, miniStatementRequest.additionalDataPrivate)
				&& Objects.equals(this.dataRecord, miniStatementRequest.dataRecord)
				&& Objects.equals(this.transactionOriginatorInstitutionIdentificationCode,
						miniStatementRequest.transactionOriginatorInstitutionIdentificationCode)
				&& Objects.equals(this.cardIssuerReferenceNumber, miniStatementRequest.cardIssuerReferenceNumber)
				&& Objects.equals(this.receivingInstitutionIdentificationCode,
						miniStatementRequest.receivingInstitutionIdentificationCode)
				&& Objects.equals(this.accountIdentification1, miniStatementRequest.accountIdentification1);
	}
	...
	public String toString() {
		...
		sb.append("class MiniStatementRequest {\n");
