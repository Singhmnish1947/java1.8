...
import com.misys.ub.fatoms.batch.bpRefresh.accountNotes.BranchPowerAccountNotesRefreshFatomContext;
...
import com.trapedza.bankfusion.steps.refimpl.AbstractBranchPowerAccountNotesRefresh;
import com.trapedza.bankfusion.utils.BankFusionMessages;

public class BranchPowerAccountNotesRefresh extends AbstractBranchPowerAccountNotesRefresh {
    ...
    String fromBranch = "";
    String toBranch = "";
    String accNotesRefFlag = "";
    /* Parameter's for Reports - End */
    Properties bfRefreshProperty = null;

    private transient final static Log logger = LogFactory.getLog(BranchPowerAccountNotesRefresh.class.getName());

    public BranchPowerAccountNotesRefresh(BankFusionEnvironment env) {
        super(env);
    }

    private static final String BATCH_PROCESS_NAME = "BranchPowerAccountNotesRefresh";
    ...
    protected AbstractFatomContext getFatomContext() {
        return (new BranchPowerAccountNotesRefreshFatomContext(BATCH_PROCESS_NAME));

    }

    public void processBatch(BankFusionEnvironment env, AbstractFatomContext ctx) throws BankFusionException {
        try {
            logger.debug("BranchPowerAccountNotesRefresh");
    ...
    protected void setOutputTags(AbstractFatomContext ctx1) {
        ...
        if (BranchPowerAccountNotesRefreshFatomContext.Status == Boolean.TRUE) {
            setF_OUT_Message("BranchPowerAccountNotesRefresh Files are Generated Successfully");
    ...
    protected void populateReportParams() {
        ...
        accNotesRefFlag = getProperty("ACCOUNT-REFRESH");
    ...
    protected void setFatomOutputTagsForReports() {
        ...
        setF_OUT_ACCOUNTNOTESREFRESH(accNotesRefFlag);
    }
}
