 ...
 * 
 */
public class OpicsSchedulerContentionContextProvider implements ExtensionPoint {

    private static final transient Log logger = LogFactory.getLog(OpicsSchedulerContentionContextProvider.class.getName());
     ...
     * Default constructor
     */
    public OpicsSchedulerContentionContextProvider() {
        attributes = new HashMap<String, Object>();
        attributes.put(CommonConstants.CONTENTION_CONTEXT, "OPICS");
    }
