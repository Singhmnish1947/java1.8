...
import com.misys.ub.fatoms.POSPostingEngineWithTryCatch;
 ...
 */
public class BranchPowerRefreshPreProcess implements IBatchPreProcess {
	/**
	...
	static {
	 ...
	 private static final transient Log logger = LogFactory.getLog(BranchPowerRefreshPreProcess.class.getName());

	/**
	 * Set environment variable
	 * @param environment For getting a handle on the BankFusion environment
	...
	public void init(BankFusionEnvironment environment) {
	}
	...
	public void process(AbstractFatomContext context) {
		...
		try {
			...
			propertiesObj[0] = loadInfoFromJar("conf/bpRefresh/BPRefresh.properties");
		}
