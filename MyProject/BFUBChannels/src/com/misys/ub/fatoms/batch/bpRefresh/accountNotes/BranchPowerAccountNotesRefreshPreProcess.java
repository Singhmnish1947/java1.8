 ...
 */
public class BranchPowerAccountNotesRefreshPreProcess implements IBatchPreProcess {
	/**
	...
	private BankFusionEnvironment env;
	 private static final transient Log logger = LogFactory.getLog(BranchPowerAccountNotesRefreshPreProcess.class.getName());
