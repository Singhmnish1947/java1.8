 ...
 *
 * ********************************************************************************
 * $Id: BranchPowerTransBundleRefreshPreProcess.java,v.1.1.2.2,Aug 21, 2008 2:58:06 PM KrishnanRR
 *
 * $Log: BranchPowerTransBundleRefreshPreProcess.java,v $
 * Revision 1.1.2.3  2008/08/22 00:26:17  krishnanr
 ...
 */
public class BranchPowerTransBundleRefreshPreProcess implements IBatchPreProcess {
    /**
    ...
    private static final  Log logger = LogFactory.getLog(BranchPowerTransBundleRefreshPreProcess.class.getName());
