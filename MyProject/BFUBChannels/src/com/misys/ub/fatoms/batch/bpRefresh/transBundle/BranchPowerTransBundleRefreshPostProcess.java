 ...
 *
 * ********************************************************************************
 * $Id: BranchPowerTransBundleRefreshPostProcess.java,v.1.1.2.1,Aug 21, 2008 2:58:06 PM KrishnanRR
 *
 * $Log: BranchPowerTransBundleRefreshPostProcess.java,v $
 ...
 */
public class BranchPowerTransBundleRefreshPostProcess implements IBatchPostProcess {
    /**
    ...
    private static final transient Log logger = LogFactory.getLog(BranchPowerTransBundleRefreshPostProcess.class.getName());
