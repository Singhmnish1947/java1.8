 ...
 *
 * ********************************************************************************
 * $Id: BranchPowerCustomerRefreshPostProcess.java,v.1.1.2.1,Aug 21, 2008 2:58:06 PM KrishnanRR
 *
 * $Log: BranchPowerCustomerRefreshPostProcess.java,v $
 ...
 */
public class BranchPowerCustomerRefreshPostProcess implements IBatchPostProcess {
    /**
    ...
    private static final transient Log logger = LogFactory.getLog(BranchPowerCustomerRefreshPostProcess.class.getName());
