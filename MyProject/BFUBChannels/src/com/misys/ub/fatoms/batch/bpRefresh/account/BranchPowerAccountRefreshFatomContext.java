 ...
 *
 * ********************************************************************************
 * $Id: BranchPowerAccountRefreshFatomContext.java,v.1.1.2.2,Aug 21, 2008 2:58:06 PM KrishnanRR
 *
 * $Log: BranchPowerAccountRefreshFatomContext.java,v $
 * Revision 1.1.2.3  2008/08/22 00:26:15  krishnanr
...
public class BranchPowerAccountRefreshFatomContext extends AbstractFatomContext {
    /**
    ...
    private static final String PROCESS_CLASSNAME = loadProcessClassName("BranchPowerAccountRefresh",
            "com.misys.ub.fatoms.batch.bpRefresh.account.BranchPowerAccountRefreshProcess");
     ...
     *            Name of the process
     */
    public BranchPowerAccountRefreshFatomContext(String batchProcessName) {
