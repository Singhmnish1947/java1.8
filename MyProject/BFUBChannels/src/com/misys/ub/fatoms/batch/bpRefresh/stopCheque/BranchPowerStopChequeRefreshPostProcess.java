 ...
 *
 * ********************************************************************************
 * $Id: BranchPowerStopChequeRefreshPostProcess.java,v.1.1.2.1,Aug 21, 2008 2:58:06 PM KrishnanRR
 *
 * $Log: BranchPowerStopChequeRefreshPostProcess.java,v $
...
public class BranchPowerStopChequeRefreshPostProcess implements IBatchPostProcess {
    /**
    ...
    private static final transient Log logger = LogFactory.getLog(BranchPowerStopChequeRefreshPostProcess.class.getName());
