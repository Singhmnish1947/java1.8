 ...
 *
 * ********************************************************************************
 * $Id: BranchPowerTransBundleRefreshFatomContext.java,v.1.1.2.1,Aug 21, 2008 2:58:06 PM KrishnanRR
 *
 * $Log: BranchPowerTransBundleRefreshFatomContext.java,v $
...
public class BranchPowerTransBundleRefreshFatomContext extends AbstractFatomContext {
    /**
    ...
    private static final String PROCESS_CLASSNAME = loadProcessClassName("BranchPowerTransBundleRefresh",
            "com.misys.ub.fatoms.batch.bpRefresh.transBundle.BranchPowerTransBundleRefreshProcess");
     ...
     *            Name of the process
     */
    public BranchPowerTransBundleRefreshFatomContext(String batchProcessName) {
