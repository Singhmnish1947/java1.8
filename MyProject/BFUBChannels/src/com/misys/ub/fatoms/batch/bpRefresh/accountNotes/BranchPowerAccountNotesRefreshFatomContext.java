...
public class BranchPowerAccountNotesRefreshFatomContext extends AbstractFatomContext {
    ...
    private static final String PROCESS_CLASSNAME = loadProcessClassName("BranchPowerAccountNotesRefresh",
            "com.misys.ub.fatoms.batch.bpRefresh.BranchPowerAccountNotesRefreshProcess");
     ...
     *            Name of the process
     */
    public BranchPowerAccountNotesRefreshFatomContext(String batchProcessName) {
