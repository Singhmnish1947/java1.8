...
public class BranchPowerRefreshFatomContext extends AbstractFatomContext {
	/**
	...
	private static final String PROCESS_CLASSNAME = loadProcessClassName("BranchPowerRefresh",
			"com.misys.ub.fatoms.batch.bpRefresh.BranchPowerRefreshProcess");
	 ...
	 *            Name of the process
	 */
	public BranchPowerRefreshFatomContext(String batchProcessName) {
	...
	/**
	 * Set of parameters gathered during BalanceSheetCollection pre-process for use in process, post process or accumulator
	 * classes. (Convienience method for generic Master/Worker handling).
	 *
	 ...
	 *
	 * The additionalParams attribute for the BSCtx are: additionalParams[0] = (Integer)numberOfReportingCurrencies
	 * additionalParams[1] = (String[])reportingCurrencies additionalParams[2] = (String)balanceSelection additionalParams[3] =
