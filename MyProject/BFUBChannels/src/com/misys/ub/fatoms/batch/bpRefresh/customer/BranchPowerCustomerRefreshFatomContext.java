 ...
 *
 * ********************************************************************************
 * $Id: BranchPowerCustomerRefreshFatomContext.java,v.1.1.2.1,Aug 21, 2008 2:58:06 PM KrishnanRR
 *
 * $Log: BranchPowerCustomerRefreshFatomContext.java,v $
...
public class BranchPowerCustomerRefreshFatomContext extends AbstractFatomContext {
    /**
    ...
    private static final String PROCESS_CLASSNAME = loadProcessClassName("BranchPowerCustomerRefresh",
            "com.misys.ub.fatoms.batch.bpRefresh.customer.BranchPowerCustomerRefreshProcess");
     ...
     *            Name of the process
     */
    public BranchPowerCustomerRefreshFatomContext(String batchProcessName) {
