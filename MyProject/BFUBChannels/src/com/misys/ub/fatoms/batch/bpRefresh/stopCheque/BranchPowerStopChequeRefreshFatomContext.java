 ...
 *
 * ********************************************************************************
 * $Id: BranchPowerStopChequeRefreshFatomContext.java,v.1.1.2.1,Aug 21, 2008 2:58:06 PM KrishnanRR
 *
 * $Log: BranchPowerStopChequeRefreshFatomContext.java,v $
...
public class BranchPowerStopChequeRefreshFatomContext extends AbstractFatomContext {
    /**
    ...
    private static final String PROCESS_CLASSNAME = loadProcessClassName("BranchPowerStopChequeRefresh",
            "com.misys.ub.fatoms.batch.bpRefresh.stopCheque.BranchPowerStopChequeRefresh");
    ...
    /**
     * BranchPowerStopChequeRefreshFatomContext
     * 
     * @param batchProcessName
     *            Name of the process
     */
    public BranchPowerStopChequeRefreshFatomContext(String batchProcessName) {
