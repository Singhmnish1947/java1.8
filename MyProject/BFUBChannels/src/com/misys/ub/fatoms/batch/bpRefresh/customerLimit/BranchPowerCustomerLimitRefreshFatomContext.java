 ...
 *
 * ********************************************************************************
 * $Id: BranchPowerCustomerLimitRefreshFatomContext.java,v.1.1.2.1,Aug 21, 2008 2:58:06 PM KrishnanRR
 *
 * $Log: BranchPowerCustomerLimitRefreshFatomContext.java,v $
 * Revision 1.1.2.2  2008/08/22 00:26:18  krishnanr
...
public class BranchPowerCustomerLimitRefreshFatomContext extends AbstractFatomContext {
    /**
    ...
    private static final String PROCESS_CLASSNAME = loadProcessClassName("BranchPowerCustomerLimitRefresh",
            "com.misys.ub.fatoms.batch.bpRefresh.customerLimit.BranchPowerCustomerLimitRefreshProcess");
     ...
     *            Name of the process
     */
    public BranchPowerCustomerLimitRefreshFatomContext(String batchProcessName) {
