 ...
 *
 * ********************************************************************************
 * $Id: BranchPowerCustomerLimitRefreshPostProcess.java,v.1.1.2.1,Aug 21, 2008 2:58:06 PM KrishnanRR
 *
 * $Log: BranchPowerCustomerLimitRefreshPostProcess.java,v $
 ...
 */
public class BranchPowerCustomerLimitRefreshPostProcess implements IBatchPostProcess {
    /**
    ...
    private static final transient Log logger = LogFactory.getLog(BranchPowerCustomerLimitRefreshPostProcess.class.getName());
