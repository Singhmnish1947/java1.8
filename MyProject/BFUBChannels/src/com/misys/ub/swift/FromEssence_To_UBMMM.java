 ...
 * @author Binit
 * 
 *         file to route outgoing swift message to ubmmm with proper tags and
 *         bic updates
 * 
 * 
 */
public class FromEssence_To_UBMMM {
	private transient final static Log LOGGER = LogFactory
			.getLog(FromEssence_To_UBMMM.class.getName());
	
	public final static String SWIFT_PROPERTY_FILENAME = "SWIFT.properties";
    public final static String CONF = "conf/swift/";

	public void executeFiles(Exchange exchange) throws ClassNotFoundException, InstantiationException, IllegalAccessException, ClassCastException, SAXException, IOException, ParserConfigurationException {
